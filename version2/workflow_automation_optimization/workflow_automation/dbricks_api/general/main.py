...
# patch request
def patch_request(url = None, headers = None, params = None, data = None):
    if params != None:
        return requests.patch(url, params = params, headers = headers, json = data)
    else: return requests.patch(url, headers = headers, json = data)
